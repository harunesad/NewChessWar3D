...
namespace Clickables
{
    ...
    public class MouseClicker : Clicker
    {
        ...
        [Tooltip("The ICursorTracker that is responsible for reporting the cursor position.")]
        ...
        public Vector2 MousePosition {  get { return cursorTracker.GetScreenPos(); } }
        #endregion
        ...
        {
            // Log warning if cursor tracker is null.
            if (cursorTracker == null)
                Debug.LogWarning("MouseClicker 'cursorTracker' field was null! Set this value, it cannot be null, it should reference a component like a MouseTracker component.", gameObject);
        }
